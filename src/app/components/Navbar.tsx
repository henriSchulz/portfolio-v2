  ...
  return (
    ...
    >
      <div className="container flex items-center justify-between mx-auto px-4 lg:px-8">
        ...
        >
          <span
            className={`font-bold tracking-tight transition-all duration-500 bg-gradient-to-r from-cyan-500 to-cyan-800 bg-clip-text text-transparent ${isScrolled ? "text-xl" : "text-2xl"}`}
          >
            HS
          </span>
        </Link>
